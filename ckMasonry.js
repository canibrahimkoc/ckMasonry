! function(t, n) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : t.ckMasonry = n()
}(this, function() {
    "use strict";
    ...
    function p(t, n) {
        ...
        M(t, o, e), v(n, function(n) {
            ...
            isNaN(o) || (t.rows.forEach(function(n, r) {
                n < t.rows[e] && (e = r)
            }), n.style.position = "absolute", n.style.top = t.rows[e] + "px", n.style.left = "" + t.cols[e], t.rows[e] += isNaN(o) ? 0 : o + i, r && (n.dataset.ckMasonryComplete = 1))
    ...
    function f(t, n) {
        ...
        M(t, o, e), v(n, function(n) {
            ...
            var e = C(n, "height");
            e = parseInt(n.offsetHeight, 10), isNaN(e) || (n.style.position = "absolute", n.style.top = t.rows[t.lastcol] + "px", n.style.left = "" + t.cols[t.lastcol], t.rows[t.lastcol] += isNaN(e) ? 0 : e + i, t.lastcol += 1, r && (n.dataset.ckMasonryComplete = 1))
        }), r && (t.tmpRows = null), l(t)
    }
    ...
    var g = function(t) {
        ...
        V = function(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                ...
                r = n ? t.container.children : h(':scope > *:not([data-ckMasonry-complete="1"])', t.container);
            r = Array.from(r).filter(function(t) {
                return null !== t.offsetParent
            });
            var o = c(t.options);
            return v(r, function(t) {
                n && (t.dataset.ckMasonryComplete = 0), t.style.width = o
    ...
    return q.init = function(t) {
        ...
        window.removeEventListener("resize", this.resizer), v(this.container.children, function(t) {
            t.removeAttribute("data-ckMasonry-complete"), t.removeAttribute("style")
        ...
        EVENT_INITIALIZED: "ckMasonry.initialized",
        EVENT_RECALCULATED: "ckMasonry.recalculated",
        EVENT_IMAGE_LOAD: "ckMasonry.image.load",
        EVENT_IMAGE_ERROR: "ckMasonry.image.error",
        EVENT_IMAGE_COMPLETE: "ckMasonry.images.complete",
        EVENT_RESIZE: "ckMasonry.resize"
